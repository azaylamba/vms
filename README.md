...
You have to design & build the backend for the application and the ability for the users to register vehicles, find vehicles, check vehicle health etc.
...
https://github.com/azaylamba/vms
